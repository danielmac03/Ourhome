...
public class Usuarios {
	...
	private List<String> respuestas_test_defecto;
	...
	public Usuarios(int id_usuarios, String nombre, String apellidos, int edad, int telefono, String correo,
			String contraseña, String rol, List<String> respuestas_test_defecto, boolean mostrar_correo,
	 ...
	 */
	public List<String> getRespuestas_test_defecto() {
	 ...
	 */
	public void setRespuestas_test_defecto(List<String> respuestas_test_defecto) {
		this.respuestas_test_defecto = respuestas_test_defecto;
	}
