...
public class TestsPersonalizados {
	...
	private List<String> respuestas_correctas;
	...
	public TestsPersonalizados(int id_test_personalizados, Usuarios id_usuario_creador,
			List<String> respuestas_correctas, int minimas_respuestas_correctas, Date fecha_creacion,
	 ...
	 */
	public List<String> getRespuestas_correctas() {
	 ...
	 */
	public void setRespuestas_correctas(List<String> respuestas_correctas) {
		this.respuestas_correctas = respuestas_correctas;
	}
