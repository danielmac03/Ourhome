...
INSERT INTO `users`
VALUES (1, 'admin', '', '', NULL, '2003-11-20', NULL, 'admin@ourhome.es',
       ...
       (2, 'Marco', 'Polo', NULL,
        ...
        '2003-11-20', 633254182, 'marcopolo@ourhome.es', '$2a$10$LG6m0k/emEcXKbjtoprGreiKGaBvMHcAQC4fB4ezPx6HUWBpRf4NS',
        'search',
        '{"p1":1,"p2":0,"p3":1,"p4":1,"p5":1,"p6":0,"p7":0,"p8":0}', _binary '', '2020-11-20', '2020-11-20'),
       (3, 'Anna', 'Mota', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 124523556, 'annamota@ourhome.es', '$2a$10$rQs/QNGT8dXvT0SI2gMdLu4UvNoa8ujKziBFLw3xeFH2oLwf8fR16',
        'have',
        '{"p1":0,"p2":1,"p3":1,"p4":1,"p5":0,"p6":1,"p7":0,"p8":1}', _binary '\0', '2020-11-20', '2020-11-20'),
       (4, 'Maria', 'Aguilea', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 665334585, 'mariaaguilea@ourhome.es',
        '$2a$10$25RlqGN/tGuqHGrDFF2KN.LUAejX0673EexFAKS9ZB1bg9jGvmJwW',
        'business', '{"p1":1,"p2":1,"p3":0,"p4":0,"p5":0,"p6":1,"p7":1,"p8":1}', _binary '', '2020-11-20',
        '2020-11-20'),
       (5, 'Sergi', 'Rober', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 665334585, 'sergirober@ourhome.es',
        '$2a$10$1uEPF91Y0LjGXyazdqzGA.zzUO49ny1t5ZPAmhZ.iNhxxFDzwB52y',
        'search', '{"p1":1,"p2":0,"p3":1,"p4":0,"p5":0,"p6":0,"p7":1,"p8":0}', _binary '', '2020-11-20', '2020-11-20'),
       (6, 'Laura', 'Mendz', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 465235596, 'lauramendz@ourhome.es',
        '$2a$10$TGtbsgQpuepnvw7unCTPcOZQSOEe5Enwox2C0nTvGIqNHDTdR.CMW', 'have',
        '{"p1":0,"p2":1,"p3":0,"p4":1,"p5":1,"p6":0,"p7":1,"p8":0}', _binary '\0', '2020-11-20', '2020-11-20'),
       (7, 'David', 'Lopez', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 564335486, 'davidlopez@ourhome.es',
        '$2a$10$jLNrixFIoOzyyWZAqIAH1ums.e2/YeVXfPQ4V8PFUxvErZmssmvL.', 'have',
        '{"p1":1,"p2":0,"p3":1,"p4":0,"p5":0,"p6":1,"p7":1,"p8":1}', _binary '', '2020-11-20', '2020-11-20'),
       (8, 'Angel', 'Gracia', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 664325998, 'davidgracia@ourhome.es',
        '$2a$10$goGXfVpqk2SqAEBKz6ZBseLKmnZKM458KaQZoxVvNOrFSpKlYsjWG',
        'search', '{"p1":0,"p2":1,"p3":0,"p4":1,"p5":1,"p6":1,"p7":0,"p8":0}', _binary '\0', '2020-11-20',
        '2020-11-20'),
       (9, 'Nuria', 'Gimenez', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 675556422, 'nuriagimenez@ourhome.es',
        '$2a$10$76/RLNiLtbZqRpSxBykYAOnvDcqiI7.CGNxNG4veEJFa6WcDi6Oz2',
        'have', '{"p1":1,"p2":0,"p3":1,"p4":0,"p5":1,"p6":0,"p7":0,"p8":1}', _binary '', '2020-11-20', '2020-11-20'),
       (10, 'Marc', 'Agoro', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 687245699, 'marcagoro@ourhome.es', '$2a$10$rHKp0thQM31b8BiRYoX9WekqgjlmwDcanNE./OB2pdCxH7vNy5UqK',
        'search',
        '{"p1":1,"p2":1,"p3":0,"p4":1,"p5":0,"p6":1,"p7":1,"p8":0}', _binary '\0', '2020-11-20', '2020-11-20'),
       (11, 'Lara', 'Palandra', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 445335586, 'larapalandra@ourhome.es',
        '$2a$10$J22iD.9j1RBLjLoi3wH8zulTUU4kNKZ57jwFaNZW3Y96cwQTwcCIm',
        'search', '{"p1":0,"p2":1,"p3":0,"p4":1,"p5":0,"p6":1,"p7":0,"p8":1}', _binary '\0', '2020-11-20',
        '2020-11-20'),
       (12, 'Alberto', 'Casanuevas', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 678559985, 'albertocasanuevas@ourhome.es',
        '$2a$10$ASyixm1li6rHdLqdwGjqp..pKPL01NogBUe2W9ymWIryZeWBF/39S',
        'have', '{"p1":1,"p2":1,"p3":1,"p4":0,"p5":1,"p6":1,"p7":1,"p8":0}', _binary '', '2020-11-20', '2020-11-20'),
       (13, 'Marcelo', 'Oros', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 645511288, 'marcelooros@ourhome.es',
        '$2a$10$NK.b/lE1qHIUUdz06eW28O23bNvrK.LJPPO.7W/c82atYugdXUfAO',
        'search', '{"p1":1,"p2":0,"p3":1,"p4":1,"p5":0,"p6":0,"p7":0,"p8":1}', _binary '', '2020-11-20', '2020-11-20'),
       (14, 'Marta', 'Cielos', NULL,
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus convallis sapien sit amet ipsum aliquet ultrices. Suspendisse lectus purus, aliquam sit amet augue non, pellentesque malesuada erat.',
        '2003-11-20', 996543996, 'martacielos@ourhome.es',
        '$2a$10$xAbevLR9CHeMBE0zinGWquDLXGO8ZoyxRTdW.mjpHryrNLXdK7PMK', 'have',
